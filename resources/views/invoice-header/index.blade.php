...
<!-- End InvoiceHeader Chart -->

        <h1>InvoiceHeaders</h1>
    ...
    <script type="text/x-template" id="grid-template">
        <div class="row">
            ...
            <tr v-for="row in data">
                ...
                <td>
                    <a href="/invoice-header/@{{row.Id}}">@{{row.Name}}</a>
                </td>
                <td>
                    @{{row.Created | formatDate}}
                </td>
                <td ><a href="/invoice-header/@{{row.Id}}/edit"> <button type="button" class="btn btn-default">Edit</button></a></td>
            </tr>
            </tbody>
        </table>
                    </div>
    ...
    <div> <a href="/invoice-header/create">
...
@section('scripts')
    ...
    <script>
        ...
        Vue.component('invoice-header-grid', {
                ...
                getData: function (page) {
                    ...
                    switch (page){
                        ...
                        case this.last_page_url :
                            ...
                            getPage = 'api/invoice-header-vue?keyword=' + this.query + '&column=' + this.sortKey + '&direction=' + this.sortOrder;
                        ...
                        case this.go_to_page :
                            ...
                            if( this.go_to_page != '' && this.go_to_page <= parseInt(this.last_page)){
                                ...
                                getPage = 'api/invoice-header-vue?page=' + this.go_to_page + '&column=' + this.sortKey + '&direction=' + this.sortOrder + '&keyword=' + this.query;
                        ...
                        default :
                            ...
                            getPage = 'api/invoice-header-vue?page=' + page + '&column=' + this.sortKey + '&direction=' + this.sortOrder + '&keyword=' + this.query;
                    ...
                    if (this.query == '' && getPage != null){
                        ...
                        if (getPage != null){
                            ...
                            this.first_page_url = 'api/invoice-header-vue?page=1&keyword=' +this.query;
                            this.last_page_url = 'api/invoice-header-vue?page=' + this.last_page + '&keyword=' +this.query;
                            this.current_page = data.current_page;
        ...
        var invoiceHeader = new Vue({
            ...
            components: 'invoice-header-grid',

            methods: {
                loadData: function () {
                    $.getJSON('api/invoice-header-vue', function (data) {
                        ...
                        this.prev_page_url = data.prev_page_url;
                        this.current_page = data.current_page;
                        this.first_page_url = 'api/invoice-header-vue?page=1';
                        this.last_page_url = 'api/invoice-header-vue?page=' + this.last_page;
                        this.setPageNumbers();
                    }.bind(this));
                },
        ...
        Vue.component('graph', {
            ...
            methods: {
                ...
                loadData: function () {
                    ...
                    $.getJSON('api/invoice-header-chart', function (data) {
                ...
                changePeriod: function () {
                    ...
                    $.getJSON('api/invoice-header-chart?period=' + this.period, function (data) {
